...
const projects = [
  {
    ...
    live: null,
    bullets: [
      'Deployed a production-ready MERN stack application (React, Node.js, MongoDB) using Docker and Kubernetes.',
      'Implemented Kubernetes resources (Deployments, Services, Ingress, ConfigMaps, Secrets, PV/PVC) for scalable and secure infrastructure.',
      'Built CI/CD pipeline using GitHub Actions with Docker Buildx, Trivy scanning, and automated deployment to Kubernetes via Docker Hub.',
      'Enabled autoscaling using HPA and managed rolling updates for zero-downtime deployments.',
    ],
  ...
  },
  {
    ...
    live: null,
    bullets: [
      'Designed and deployed a highly available 3-tier WordPress architecture on AWS using Terraform (IaC).',
      'Implemented scalable infrastructure with ALB, EC2 Auto Scaling Group, RDS MySQL, and EFS across multiple Availability Zones.',
      'Configured secure networking using VPC architecture with public/private/database subnets, NAT Gateway, and security groups.',
      'Automated full infrastructure provisioning and management using Terraform with reusable and parameterized modules.',
    ],
